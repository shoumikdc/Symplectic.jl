...
# Define Shorthand Notation for Indices
↑(m, i) = 2 * m - (i % 2)
↓(m, i) = 2 * m - 1 + (i % 2)
...
# calculate the "non-symplecticity" of a matrix.
...
"""Make S1 and S4 to be identity! Then can use two couplers."""
...
# Get local Operations L16, L15, ..., L1 for the interfernce-based sequence LR S L15 S ... S L1 S = ST, with a given target Symplectic Matrix ST
...
# Want to decouple 3rd modes. So let inModes = outModes = [1, 2]
...
# M is a positive real symmetric matrix.
